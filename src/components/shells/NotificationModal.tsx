  ...
  const loadNotifications = useCallback(async () => {
    ...
    if (isStudent) {
        ...
        try {
          ...
          activeSessions.forEach((s: StudentSessionSummary) => {
            items.push({
              ...
              description: `Sesi bersama ${s.kaderName ?? "Kader Sebaya"} aktif. Ketuk untuk melanjutkan obrolan.`,
          ...
          waitingSessions.forEach((s: StudentSessionSummary) => {
            items.push({
              ...
              description: `Permintaan ceritamu telah dikirim ke ${s.kaderName ?? "Kader Sebaya"}. Mohon tunggu sejenak.`,
              timestamp: formatRelativeTime(s.lastMessageAt),
              href: `/student/chat/${s.id}`,
          ...
          if (recentEndedSessions.length > 0) {
            ...
            items.push({
              ...
              description: `Sesi bersama ${latestEnded.kaderName ?? "Kader Sebaya"} telah diakhiri. Terima kasih telah berbagi cerita!`,
      ...
      items.push({
        ...
        description: "Pantau ringkasan tren isu siswa dan eskalasi krisis dari kader sebaya secara berkala.",
        timestamp: "Sistem",
        iconType: "system",
      });
    }
